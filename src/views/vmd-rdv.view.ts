            ...
            `:html`
                <h3 class="fw-normal text-center h4 ${classMap({ 'search-chronodose': SearchRequest.isChronodoseType(this.currentSearch), 'search-standard': SearchRequest.isStandardType(this.currentSearch) })}"
                    ...
                    ${SearchRequest.isChronodoseType(this.currentSearch)
                        ? `${this.totalCreneaux.toLocaleString()}  vaccintid${Strings.plural(this.totalCreneaux, "er")} chronodose${Strings.plural(this.totalCreneaux)} hittade`
                        : `${this.totalCreneaux.toLocaleString()} vaccintid${Strings.plural(this.totalCreneaux, "er")} hittade`
                    }
